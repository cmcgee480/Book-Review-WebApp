...
<head>
    ...
    <title>FAVOURITES DELETED</title>
...
<section id="header">
    ...
    <div class="jumbotron text-center" style="height:60vh;">
        <div class="intro">
            <h2 data-aos="fade" data-aos-duration="2000">We have edited your favourites...
                <i class="fa fa-book"></i>
            </h2>
        </div>
    </div>
    <script>
        swal("Deleted from your favourites!");
    </script>
    <div class='content'>
        ...
        <?php
            ...
            echo"<h2>Go back to Favourites..</h2>
            <a href='viewfavourites.php' class='btn btn-primary'>BACK</a>";
